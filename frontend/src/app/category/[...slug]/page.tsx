      ...
      <main className="container mx-auto px-6 py-8 md:py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-1 w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-x-6 gap-y-12 md:gap-x-10 md:gap-y-16">
        ...
        {isFilterOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 w-[300px] bg-white z-[101] shadow-2xl p-8 overflow-y-auto"
            >
