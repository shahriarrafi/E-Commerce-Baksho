...
export default function TrackOrderPage() {
  ...
  return (
    <div className="min-h-screen bg-brand-cream/5 pt-32 pb-20">
      <div className="container mx-auto px-6 max-w-2xl">
        <Link href="/" className="inline-flex items-center gap-2 text-brand-navy/40 hover:text-brand-orange transition-colors mb-12 group">
